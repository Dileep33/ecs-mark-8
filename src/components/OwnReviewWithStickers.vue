    ...
    <li class="ownReview" v-else>
        <div  v-if="authorId !== getUserDetails.authorId" class="comment-main-level">
            <div class="selected-rating">
                <img v-if="userPratilipiData.rating == 1" class="rating-stickers" :src="getRatingStickerSource(1)" >
                <img v-if="userPratilipiData.rating == 2" class="rating-stickers" :src="getRatingStickerSource(2)" >
                <img v-if="userPratilipiData.rating == 3" class="rating-stickers" :src="getRatingStickerSource(3)" >
                <img v-if="userPratilipiData.rating == 4" class="rating-stickers" :src="getRatingStickerSource(4)" >
                <img v-if="userPratilipiData.rating == 5" class="rating-stickers" :src="getRatingStickerSource(5)" >
            </div>
            <div class="comment-box">
                ...
                <div class="rate-now" v-if="( !userPratilipiData.reviewDateMillis || editRatingMode ) && shouldShowRatingSelection">
                    <fieldset class="rating" @click="openReview" v-if="shouldShowRatingSelection">
                        <img @click="changeRating(1)" class="rating-stickers" :class="{ 'selected': userPratilipiData.rating === 1 }" :src="getRatingStickerSource(1)" />
                        <img @click="changeRating(2)" class="rating-stickers" :class="{ 'selected': userPratilipiData.rating === 2 }" :src="getRatingStickerSource(2)" />
                        <img @click="changeRating(3)" class="rating-stickers" :class="{ 'selected': userPratilipiData.rating === 3 }" :src="getRatingStickerSource(3)" />
                        <img @click="changeRating(4)" class="rating-stickers" :class="{ 'selected': userPratilipiData.rating === 4 }" :src="getRatingStickerSource(4)" />
                        <img @click="changeRating(5)" class="rating-stickers" :class="{ 'selected': userPratilipiData.rating === 5 }" :src="getRatingStickerSource(5)" />

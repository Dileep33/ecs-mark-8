...
export default {
    ...
    methods: {
        ...
        triggerFbEndShareEvent() {
            ...
            this.triggerAnanlyticsEvent(`SHAREBOOKFB_BOOKEND_READER`, 'WREC002', {
        ...
        triggerGpEndShareEvent() {
            ...
            this.triggerAnanlyticsEvent(`SHAREBOOKGP_BOOKEND_READER`, 'WREC002', {
                ...pratilipiAnalyticsData,
                'USER_ID': this.getUserDetails.userId,
        ...
        triggerTwEndShareEvent() {
            ...
            this.triggerAnanlyticsEvent(`SHAREBOOKTW_BOOKEND_READER`, 'WREC002', {
                ...pratilipiAnalyticsData,
                'USER_ID': this.getUserDetails.userId,
        ...
        triggerWaEndShareEvent() {
            ...
            this.triggerAnanlyticsEvent(`SHAREBOOKWA_BOOKEND_READER`, 'WREC002', {
                ...pratilipiAnalyticsData,
                'USER_ID': this.getUserDetails.userId,
    ...
    watch: {
        'inViewport.now': function(visible) {
            if (visible) {
                this.triggerAnanlyticsEvent(`LANDED_BOOKEND_READER`, 'WREC002', {
                    'USER_ID': this.getUserDetails.userId
                });
            }
        }

      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title">__("share_ui_title_1")</h5>
...
export default {
    ...
    methods: {
        ...
        triggerFbShareEvent() {
            ...
            this.triggerAnanlyticsEvent(`${action}_${this.getScreenDetails.screen_location}_${this.getScreenDetails.screen_name}`, 'WSH002', {

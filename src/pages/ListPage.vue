                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="list-tabs">
                            ...
                            <a href="#" @click="listchange" :class="{'active': (currentLocale === 'hi' && this.isFilterActive == true )}" data-tab="tab-high_rated" v-if="this.isFilterActive">__("sorting_highly_rated")</a>

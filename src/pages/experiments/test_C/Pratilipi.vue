<template>
    <MainLayout>
        <div class="pratilipi-page page-wrap">
            ...
            <LoginDrawer v-if="this.getUserDetails.isGuest && (getCookie('bucket_id') >= 87 && getCookie('bucket_id') <=99)"></LoginDrawer>
...
import LoginDrawer from '@/components/experiments/test_C/LoginDrawer';

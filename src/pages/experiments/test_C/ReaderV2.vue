                    ...
                    <div class="row">
                        ...
                        <div class="col-12 p-0" v-else>
                            ...
                            <WebPushModalV3
                                ...
                                v-if="getIndexData[getIndexData.length -1].slugId === currentChapterSlugId && isWebPushModalEnabled && this.currentLocale !== 'en'"></WebPushModalV3>
                        </div>
                    </div>
                </div>
            </div>
...
import WebPushModalV3 from '@/components/experiments/test_C/WebPushModal.vue';

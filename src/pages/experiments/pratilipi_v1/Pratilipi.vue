        ...
        <div class="container">
            <div class="row" v-if="getPratilipiLoadingState === 'LOADING_SUCCESS'" itemscope itemtype="http://schema.org/Book">
                ...
                <div class="book-synopsis col-md-12 col-lg-7 p-0">
                    <div class="card">
                        <div v-if="getPratilipiData.state === 'DRAFTED' || getPratilipiData.hasAccessToUpdate">
                    ...
                    <div class="card reviews-section">
                        ...
                        <Reviews :pratilipiId="getPratilipiData.pratilipiId" :authorId="getPratilipiData.author.authorId" :userPratilipiData="getUserPratilipiData" :haveInfiniteScroll="false" screenName="BOOK" screenLocation="RATEREV" :pratilipiData="getPratilipiData" v-if="getPratilipiLoadingState === 'LOADING_SUCCESS'">
                        </Reviews>
                        ...
                        <div class="review-popout" v-if="getPratilipiLoadingState === 'LOADING_SUCCESS'">
                            ...
                            <Reviews :pratilipiId="getPratilipiData.pratilipiId" :authorId="getPratilipiData.author.authorId" :haveInfiniteScroll="true" screenName="BOOK" screenLocation="RATEREV" :pratilipiData="getPratilipiData" :userPratilipiData='getUserPratilipiData'>
                            </Reviews>
                        </div>
                ...
                <div class="book-recomendations col-md-12 p-0">
                    <div class="card">
                        <Recommendation :contextId="getPratilipiData.pratilipiId" :context="'summaryPage'" screenName="BOOK" screenLocation="RECOMMENDBOOK" v-if="getPratilipiData && getPratilipiData.pratilipiId">
                        </Recommendation>
                    </div>
                </div>
            </div>
            ...
            <WebPushModal screenName="PRATILIPI" title="__('web_push_title')" message="__('web_push_message_2')" :includeDisableButton=true v-if="isWebPushModalEnabled && this.currentLocale !== 'en'"></WebPushModal>
        </div>
...
export default {
    ...
    methods: {
        ...
        showAlertToGoToDesktop() {
            ...
            this.triggerAlert({
                message: '__("write_on_desktop_only")',
                timer: 3000
            });
        },
        ...
        addOrRemoveFromListOfSelectedTag(tagData, isDeselectOperation) {
            ...
            if (this.selectedTags.length === 3 && !isDeselectOperation) {
                this.triggerAlert({
                    message: '__("tags_select_best_three")',
                    timer: 3000
                });
                return;
            }
        ...
        addPratilipiToLibrary(pratilipiId) {
            ...
            if (this.getUserDetails.isGuest) {
                this.setAfterLoginAction({
                    action: `${this.$route.meta.store}/addToLibrary`,
                    data: pratilipiId
                });
        ...
        openShareModal() {
            ...
            this.setShareDetails({
                data: this.getPratilipiData,
                type: 'PRATILIPI',
                screen_name: 'BOOK',
                screen_location: 'BOOKM'
            })
        ...
        hideStripAndRedirect() {
            ...
            this.$router.push({
                path: '/read',
                query: {
                    id: String(this.getPratilipiData.nextPratilipi.pratilipiId)
                }
            });
        }
    },
    ...
    watch: {
        ...
        'getPratilipiData.pratilipiId' (newId) {
            ...
            this.selectedTags = this.getPratilipiData.tags ? [...this.getPratilipiData.tags] : [];
            this.suggestedTags = this.getPratilipiData.suggestedTags;
            document.title = this.getPratilipiData.titleEn === "" || this.getPratilipiData.titleEn === null || this.getPratilipiData.titleEn === "undefined" || this.getPratilipiData.titleEn === "null" || this.getPratilipiData.titleEn === undefined ?
                this.getPratilipiData.title : this.getPratilipiData.title + " | " + this.getPratilipiData.titleEn;

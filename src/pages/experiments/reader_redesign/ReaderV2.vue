...
export default {
    ...
    watch: {
        ...
        'getPratilipiData.pratilipiId' (pratilipiId) {
            ...
            // this.isWebPushStripEnabled = this.getPratilipiData.state === "PUBLISHED" && WebPushUtil.canShowCustomPrompt() && (parseInt(this.getCookie('bucket_id')) || 0) >= 20 && (parseInt(this.getCookie('bucket_id')) || 0) < 30
            this.isWebPushModalEnabled =  this.getPratilipiData.state === "PUBLISHED" && WebPushUtil.canShowCustomPrompt() && (parseInt(this.getCookie('bucket_id')) || 0) > 40 && (parseInt(this.getCookie('bucket_id')) || 0) <= 55
            if (this.getPratilipiData.state === "PUBLISHED" && WebPushUtil.canShowCustomPrompt() && (parseInt(this.getCookie('bucket_id')) || 0) > 55 && (parseInt(this.getCookie('bucket_id')) || 0) <= 70) {

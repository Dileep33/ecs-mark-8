            ...
            <div class="header-section" :class="getReaderReadingModeStyle">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="book-name tool-icon-7" @click="openSidebar">
                            <i class="material-icons">menu</i>
                        </div>
                        <div class="right-icons">
                            <div class="add-to-lib tool-icon-1">
...
export default {
    ...
    methods: {
        ...
        addPratilipiToLibrary() {
            this._triggerReaderAnalyticsEvent('LIBRARYADD_BOTTOMBAR_READER', null, null, 'WRH001')
            if (this.getUserDetails.isGuest) {
        ...
        removePratilipiFromLibrary() {
            this._triggerReaderAnalyticsEvent('LIBRARYREMOVE_BOTTOMBAR_READER', null, null, 'WRH001')
        ...
        openSidebar() {
            ...
            this._triggerReaderAnalyticsEvent('CLICKMENU_TOPBAR_READER', null, null, "WRH001")
        },
        closeSidebar() {
